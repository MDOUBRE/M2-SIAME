...
<cheddar>
 ...
 <tasks>
  <periodic_task id="id_5">
   ...
   <name>DISTRIBUTION_DONNEES</name>
 ...
 <resources>
  <pcp_resource id="id_20">
   ...
   <critical_sections>
    <task_name>DISTRIBUTION_DONNEES</task_name>
    <critical_section>
     <task_begin>1</task_begin>
     <task_end>5</task_end>
    </critical_section>
    <task_name>TACHE_PILOTAGE</task_name>
    <critical_section>
     <task_begin>1</task_begin>
     <task_end>5</task_end>
    </critical_section>
    <task_name>TACHE_MESURES</task_name>
    <critical_section>
     <task_begin>1</task_begin>
     <task_end>10</task_end>
    </critical_section>
    <task_name>TACHE_METEO</task_name>
    <critical_section>
     <task_begin>1</task_begin>
     <task_end>15</task_end>
    </critical_section>
   </critical_sections>
   <cpu_name>proc1</cpu_name>
   <address_space_name>addr1</address_space_name>
